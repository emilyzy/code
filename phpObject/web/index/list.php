...
$tid = $_GET["tid"];
$sql = "SELECT * FROM article WHERE tid=$tid ORDER BY date";
$r = $db->query($sql);
    ...
    <div class="content-wrap"><!--内容-->
        <div class="content" style="padding-bottom: 800px">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <h2 class="title"><strong><?php echo $_GET['typename']; ?></strong></h2>
                <div class="row">
                    <?php foreach ($article as $v): ?>
                        <div class="news-list">
                            <div class="news-img col-xs-5 col-sm-5 col-md-4"><a target="_blank" href="content.php?aid=<?php echo $v['id']?>"><img src="<?php echo $v['thumb'] ?> " alt=""> </a></div>
